...
#if defined(CONFIG_INPUT_MAX14688) || defined(CONFIG_CHARGER_BQ24296) \
	|| defined(CONFIG_CHARGER_UNIFIED_WLC) || defined(CONFIG_TOUCHSCREEN_SYNAPTICS_I2C_RMI4)
bool i2c_suspended;
#endif
...
#if defined(CONFIG_INPUT_MAX14688) || defined(CONFIG_CHARGER_BQ24296) || defined(CONFIG_CHARGER_UNIFIED_WLC)
	i2c_suspended = true;
#endif
	if (dev->pwr_state == MSM_I2C_PM_ACTIVE) {
