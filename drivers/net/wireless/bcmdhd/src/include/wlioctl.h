 ...
 *
 * $Id: wlioctl.h 468737 2014-04-08 17:59:20Z $
 */
...
typedef BWL_PRE_PACKED_STRUCT struct {
	...
	int8 clm_limits[WL_NUMRATES];		/* regulatory limits - 20, 40, 80, 160, 8080MHz */
	int8 clm_limits_subchan1[WL_NUMRATES];
					/* regulatory limits - 20in40, 40in80, 80in160, 80in8080 */
	int8 clm_limits_subchan2[WL_NUMRATES];	/* regulatory limits - 20in80, 40in160, 40in8080 */
	...
	int8 clm_limits_subchan3[WL_NUMRATES];  /* regulatory limits - 20in160, 20in8080 */
	int8 clm_limits_subchan4[WL_NUMRATES];  /* regulatory limits - 8080chan2 */
